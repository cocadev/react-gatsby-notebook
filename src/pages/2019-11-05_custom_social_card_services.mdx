...
I’ve now created custom cards for all pages on both Notebook & my [IMA blog](https://ima.google.com):
...
One nice touch is that the service supports a dark mode, which you can automatically use for special posts. On Notebook, that’s my non-dated pages like [Tools](https://notebook.google.com/tools/), and on IMA, I made midterm & final projects use dark mode. If you never touch it, that works too.
