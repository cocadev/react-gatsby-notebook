...
*Note: the following is extracted from [my tutorial on building a hackathon website](https://notebook.eugene.me/2019-09-06_making_a_hackathon_site/).*
...
I wrote a bit more about how styling is used at a component level [over here about the Hack Pennsylvania site](https://notebook.eugene.me/2019-08-15_hack_penn_site/).
