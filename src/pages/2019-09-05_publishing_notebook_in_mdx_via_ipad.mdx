...
> Before you ask, yes, this site is open source. [Read the source](https://glitch.com/~eugene-notebook)
...
This means [the Glitch preview](https://eugene-notebook.glitch.me) is just that—a preview. For real visitors, they’re getting the static site served by a CDN, instead of a tiny development server that takes a minute to boot up.
...
Regarding `New Notebook Page`: Remember to change the project URL to yours at the end! I have two notebooks, this one & [one for my college major coursework](https://ima.google.com)—if you just have one, delete the Choose from Menu near the end.
