...
Regarding `New Notebook Page`: Remember to change the project URL to yours at the end! I have two notebooks, this one & [one for my college major coursework](https://ima.eugene.com)—if you just have one, delete the Choose from Menu near the end.
