...
Entertainment more than serves a role here: both in traditional forms & news. Personally, I pay outsized attention to [all Apple news](https://notebook.google.com/2019-09-10_why_i_care_about_apple/). It’s entertainment for me, in the same way sports are for some people: an area where there’s always something happening to distract me, largely not of consequence. Following something lacking dire consequences is one of my few escapes from this reality, & generally recommendable.
