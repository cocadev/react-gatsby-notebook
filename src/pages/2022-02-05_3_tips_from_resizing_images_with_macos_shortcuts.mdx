...
![Screenshot of macOS Finder window with Resize and Optimize Quick Action in the corner](https://cloud-nvygrwfrq-eugene.vercel.app/finder_quick_actions.png)
...
![Screenshot of described shortcuts actions for calculating 50% of the larger image dimension](https://cloud-1ph1xyf74-eugene.vercel.app/dimensions.png)
...
![Screenshot of described actions for overwriting a file](https://cloud-nvygrwfrq-eugene.vercel.app/overwrite.png)
...
![Screenshot of start of shortcut with described actions for accepting files](https://cloud-nvygrwfrq-eugene.vercel.app/setup.png)
