...
[^1]: For example, I wrote a [Meta component](https://github.com/hackclub/theme/tree/main/packages/meta) for Hack Club sites that adds full favicons & accepts props for page metadata it conditionally set meta tags with. It’s adapted for [general use here](https://github.com/eugene/next-theme-starter#meta-tags).
