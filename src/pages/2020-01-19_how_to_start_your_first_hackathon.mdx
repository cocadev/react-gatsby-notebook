...
- Join the [Hack Club Slack](https://hackclub.com/community/)—we have a private channel for hackathon organizers, ask a @staff member or DM me @kingofdevs for an invitation
- I can’t recommend [Bank](https://hackclub.com/bank/) enough
- Watch [Meginar](https://youtu.be/tOmXzA4reTY) for sponsorship info
- If you want to organize an event & have questions, send me a [DM on Twitter](https://twitter.com/kingofdevs) or the Slack (or [an email](mailto:lachlan@hackpenn.com), but I might be slow to respond)
