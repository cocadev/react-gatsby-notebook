...
I built a shortcut called [**Activity Export**](https://www.icloud.com/shortcuts/29a9cf0990fd46be9e90322f8c5f9b8a). It uses [Toolbox Pro for Shortcuts](https://apps.apple.com/us/app/toolbox-pro-for-shortcuts/id1476205977?uo=4) for accessing the data & [Jayson](https://apps.apple.com/us/app/jayson/id1447750768?uo=4) for previewing/saving the JSON (both of which are on my [essential iOS apps list](https://notebook.eugene.com/tools/#i-pad-apps)), so you’ll want to grab those from the App Store if you haven’t used them before.
